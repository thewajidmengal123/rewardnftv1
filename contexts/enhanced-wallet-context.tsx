...
//   connectionPreferences: WalletPersistence.WalletSession
//   updateConnectionPreferences: (prefs: Partial<WalletPersistence.WalletSession>) => void
...
//         WalletPersistence.clearSelectedWallet()
