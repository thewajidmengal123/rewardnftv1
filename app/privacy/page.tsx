...
>>>>>>> 65a7781ebc257a9fff0c7f01f5d6835e74699010
                  <li>
                    Once an NFT is minted, users unlock access to the referral system,
                    quests, mini-games, and airdrops.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    Commissions are credited to the user's Phantom wallet on the Solana chain.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    Users can participate in quests and mini-games to earn additional rewards.
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    Users are responsible for maintaining the security of their wallet
                    and account information.
                  </li>
                  <li>
                    Any activities conducted through their account are their responsibility.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    RewardNFT provides its services on an "as is" basis and does not
                    guarantee specific earnings or outcomes.
                  </li>
                  <li>
                    The platform is not responsible for any losses incurred by users.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    RewardNFT reserves the right to modify or discontinue any part of
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    RewardNFT may suspend or terminate accounts that violate these terms
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    All content on the platform, including logos, graphics, and text,
                    is the property of RewardNFT and protected by intellectual property laws.
                  </li>
                  <li>
                    Users may not use this content without prior written consent.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  RewardNFT is not liable for any indirect, incidental, or consequential
              ...
              <section>
                ...
                <p>
                  ...
                  with the laws of the jurisdiction in which RewardNFT operates.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  RewardNFT reserves the right to update these terms at any time.
